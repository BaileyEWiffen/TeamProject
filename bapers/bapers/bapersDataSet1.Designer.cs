...
namespace bapers {
    ...
    public partial class bapersDataSet1 : global::System.Data.DataSet {
        ...
        public partial class jobDataTable : global::System.Data.TypedTableBase<jobRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public jobRow AddjobRow(System.DateTime deadline, string Status) {
...
namespace bapers.bapersDataSet1TableAdapters {
    ...
    public partial class jobTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `job` WHERE ((`job_number` = @p1) AND (`deadline` = @p2) AND (`Status" +
                "` = @p3))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `job` SET `deadline` = @p1, `Status` = @p2 WHERE ((`job_number` = @p3) AND" +
                " (`deadline` = @p4) AND (`Status` = @p5))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `job_number`, `deadline`, `Status` FROM `job`";
